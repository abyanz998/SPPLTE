    ...
    require_once('../../plugins/tcpdf/tcpdf.php');
     ...
     if (isset($_SESSION['idUsers'])){
        ...
        while ($kas = mysqli_fetch_array($sql_akunKas)) {
            ...
            $pdf->AddPage();
            //setting title
            $pdf->SetTitle('Laporan Per Jenis Anggaran Kas Tunai per Tanggal '.tgl_raport($tgl_mulai).' Sampai '.tgl_raport($tgl_akhir).'Tahun Ajaran '.$ta['nmTahunAjaran']);
            //isi pdf
            ...
            $html = '<table style="font-size: 8pt" cellpadding="1" border="0">
                        ...
                        <tr><td></td></tr>
                        <tr>
                            <td align="center" style="font-size: 8pt"><b>Laporan per Jenis Anggaran Kas Tunai per Tanggal '.tgl_raport($tgl_mulai).' Sampai '.tgl_raport($tgl_akhir).'</b><br>Tahun Ajaran '.$ta['nmTahunAjaran'].'</td>
                        </tr>
        ...
        $file ='Rekap Laporan Kas Tunai per Jenis Anggaran per Tanggal '.tgl_raport($tgl_mulai).' Sampai '.tgl_raport($tgl_akhir).'Tahun Ajaran '.$ta['nmTahunAjaran'].'.pdf';
