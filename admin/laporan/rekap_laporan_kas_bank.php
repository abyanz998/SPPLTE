    ...
    require_once('../../plugins/tcpdf/tcpdf.php');
     ...
     if (isset($_SESSION['idUsers'])){
        ...
        while ($kas = mysqli_fetch_array($sql_akunKas)) {
            ...
            $pdf->AddPage();
            //setting title
            $pdf->SetTitle('Rekap Laporan (Kas Bank) per Tanggal '.tgl_raport($tgl_mulai).' Sampai '.tgl_raport($tgl_akhir).'</b><br>Tahun Ajaran '.$ta['nmTahunAjaran']);
            //isi pdf
            ...
            $html = '<table style="font-size: 8pt" cellpadding="1" border="0">
                        ...
                        <tr><td></td></tr>
                        <tr>
                            <td align="center" style="font-size: 8pt"><b>Rekap Laporan (Kas Bank) per Tanggal '.tgl_raport($tgl_mulai).' Sampai '.tgl_raport($tgl_akhir).'</b><br>Tahun Ajaran '.$ta['nmTahunAjaran'].'</td>
                        </tr>
        ...
        $file ='Rekap Laporan (Kas Bank) per Tanggal '.tgl_raport($tgl_mulai).' Sampai '.tgl_raport($tgl_akhir).'</b><br>Tahun Ajaran '.$ta['nmTahunAjaran'].'.pdf';
