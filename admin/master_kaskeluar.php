                  ...
                  <table id="example1" class="table table-hover dataTable no-footer">
                    ...
                    <?php 
                      if (isset($_GET['unit'])){
                        if ($_GET['unit'] != 'all'){
                          $tampil = mysqli_query($koneksi,"SELECT kas.*, 
                                                         ...
                                                         WHERE kas.stdel='0' AND kas.jenis='Keluar' AND kas.idUnitSekolah='$_GET[unit]' AND kas.tipe<>'Transfer' ORDER BY kas.idKas DESC");
                        }else{
                          $tampil = mysqli_query($koneksi,"SELECT kas.*, 
                                                                akun_biaya.keterangan as ketAkun,
                                                                pajak.besaranPajak,
                                                         ...
                                                         LEFT JOIN pajak ON kas.idPajak = pajak.idPajak
                                                         LEFT JOIN unit_pos ON kas.idUnitPos = unit_pos.idUnitPos
                                                         WHERE kas.stdel='0' AND kas.jenis='Keluar' AND kas.tipe<>'Transfer' ORDER BY kas.idKas DESC");
                        }
                        ...
                        $tampil = mysqli_query($koneksi,"SELECT kas.*, 
                                                         ...
                                                         LEFT JOIN pajak ON kas.idPajak = pajak.idPajak
                                                         LEFT JOIN unit_pos ON kas.idUnitPos = unit_pos.idUnitPos
                                                         WHERE kas.stdel='0' AND kas.jenis='Keluar' AND kas.idUnitSekolah='$idUnitUsers' AND kas.tipe<>'Transfer' ORDER BY kas.idKas DESC");
                      }else{
                        $tampil = mysqli_query($koneksi,"SELECT kas.*, 
                                                                akun_biaya.keterangan as ketAkun,
                                                                pajak.besaranPajak,
                      ...
                      while($r=mysqli_fetch_array($tampil)){
                        ...
                        echo "<tr>
                                ...
                                <td width='80px'><center>
                                  <a class='btn btn-success btn-xs' data-toggle='tooltip' title='' data-original-title='Cetak' target='_blank' href='admin/laporan/transaksi_kas_keluar.php?noref=".$r[noRefrensi]."'><span class='fa fa-print'></span></a> 
                      ...
                      if (isset($_POST['hapus'])){
                          ...
                          $slip = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM pegawai_gaji_slip WHERE noRefrensi='$_POST[kas_noref]' AND stdel='0'"));
                          $pegawai = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM pegawai WHERE idPegawai='$slip[idPegawai]'"));
                          ...
                          if ($_POST['tipe'] == 'Gaji'){
                            ...
                            mysqli_query($koneksi,"INSERT INTO log_transaksi(tanggal,modul,aksi,info,penulis,browser,os,ip_address) VALUES ('$waktu_sekarang','Kas Keluar','Hapus Gaji','$info','$idUsers','$browser_ok','$user_os','$ip')");

                            $title = 'Hapus Gaji '.$_POST['keterangan'];
                            mysqli_query($koneksi,"INSERT INTO log_kasir(tanggal,jenisBayar,idBayar,modul,aksi,noRefrensi,nis_nip,title,nominal,penulis,browser,os,ip_address) VALUES ('$waktu_sekarang','Kas','$_POST[id_kas]','Penggajian','Hapus','$_POST[kas_noref]','$pegawai[nipPegawai]','$title','$_POST[total]','$idUsers','$browser_ok','$user_os','$ip')");
                          }else{
                            $info = 'No. Ref:'.$_POST['kas_noref'].';Title:Hapus '.$_POST['tipe'].' '.$_POST['keterangan'].' - nominal '.$_POST['total'];
                            ...
                            mysqli_query($koneksi,"INSERT INTO log_kasir(tanggal,jenisBayar,idBayar,modul,aksi,noRefrensi,nis_nip,title,nominal,penulis,browser,os,ip_address) VALUES ('$waktu_sekarang','Kas','$_POST[id_kas]','Kas Keluar','Hapus Transaksi','$_POST[kas_noref]',null,'$title','$_POST[total]','$idUsers','$browser_ok','$user_os','$ip')");
                          }
...
<?php 
  ...
  if (isset($_POST[update])){ 
    ...
    mysqli_query($koneksi,"INSERT INTO log_transaksi(tanggal,modul,aksi,info,penulis,browser,os,ip_address) VALUES ('$waktu_sekarang','Kas Keluar','Edit Transaksi','$info','$idUsers','$browser_ok','$user_os','$ip')");
          ...
          <div class="box-body">
           <input type="hidden" name="id_kas" value="<?= $record[idKas]?>">
              ...
              <div class="input-group date date-picker" data-date="" data-date-format="yyyy-mm-dd">
                ...
                <input class="form-control" type="text" name="tanggal_kas" readonly="readonly" placeholder="Tanggal Kas Keluar" value="<?= $record['tanggal'] ?>">
              </div>
              <br>
              ...
              <input type="hidden" id="idAkunGajiBiaya" value="<?= $record['idKodeAkun'] ?>"> 
              <select required="" name="id_akun_biaya" id="Cakungajibiaya" class="form-control">
                  <option value="">- Pilih Kode Akun -</option>
              </select>
              <br>
              <label>Keterangan *</label>
              <input type="text" class="form-control" name="keterangan" value="<?= $record['keterangan'] ?>" placeholder="Keterangan Kas Keluar">
              <br>
            ...
            <div class="box-body">      
                <input type="hidden" name="id_tahun_ajaran" id="id_tahun_ajaran" value="<?= $ta['idTahunAjaran'] ?>">
                  <div class="row">
                    ...
                    <div class="input-group date date-picker" data-date="" data-date-format="yyyy-mm-dd">
                      <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                      <input class="form-control" required="" type="text" name="tanggal_kas" id="tanggal_kas" placeholder="Tanggal Kas Keluar" value="<?= $tanggal_sekarang ?>">
                    </div>
                    </div>
                    <div class="col-md-3">
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <label>Keterangan *</label>
                      <input type="text" required="" name="keterangan_kas" id="keterangan_kas" class="form-control" placeholder="Keterangan Kas Keluar">
                    </div>
                    <div class="col-md-3">
                    </div>
                    <div class="col-md-3">
                      <label>Total *</label>
                      <input type="text" required="" name="total_kas" id="total_kas" class="form-control" placeholder="Total Kas Keluar" readonly="">
                    </div>
                    <div class="col-md-3">
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-2">
                      <div id="div_kode">
                        ...
                        <select required="" name="id_akun_biaya" id="Cakunbiayakeluar" class="form-control">
                            <option value="">- Pilih Kode Akun -</option>
                        </select>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <label>Uraian *</label>
                      <input type="text" required="" name="keterangan" id="keterangan" class="form-control" placeholder="Uraian Kas Keluar">
                    </div>
                    <div class="col-md-2">
                      <label>Nominal (Rp.)*</label>
  ...
  <script type="text/javascript">
    ...
    function tampil_data(){
        ...
        $.ajax({
            ...
            url : "admin/kas/transaksi_kas_keluar.php",
            method : "POST",
    ...
    $('#btn_selesai').on('click',function(){
        ...
        $('#btn_simpan').on('click',function(){
            ...
            var kas_noref=$("#kas_noref").val();
            var id_akun_biaya=$("#Cakunbiayakeluar").val();
