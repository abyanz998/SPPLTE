...
if (isset($_SESSION['idUsers'])){
    ...
    $file = 'Rekap Laporan Kas Bank per Tanggal '.tgl_raport($tgl_mulai).' Sampai '.tgl_raport($tgl_akhir).'Tahun Ajaran '.$ta['nmTahunAjaran'];
    ...
    $saldo_awal = 0;
        ...
        while ($kas = mysqli_fetch_array($sql_akunKas)) {
            ...
            echo '<table style="font-size: 8pt" cellpadding="1" border="0">
                        ...
                        <tr><td></td></tr>
                        <tr>
                            <td align="center" style="font-size: 10pt"><b>Rekap Laporan Kas Bank per Tanggal '.tgl_raport($tgl_mulai).' Sampai '.tgl_raport($tgl_akhir).'</b><br>Tahun Ajaran '.$ta['nmTahunAjaran'].'</td>
                        </tr>
                                                ...
                                                //kas masuk
                                                    ...
                                                    while ($tkas = mysqli_fetch_array($sqlKas)) {
                                                        if ($tkas['tipe'] != 'Transfer'){
                                                            ...
                                                            $akun = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM WHERE idAkun='$tkas[idAkunKasTujuan]'"));
