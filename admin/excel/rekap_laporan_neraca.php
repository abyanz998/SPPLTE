...
if (isset($_SESSION['idUsers'])){
    ...
    $file = 'Laporan Neraca '.$unit.' per Bulan '.$bln1['nmBulan'].' Sampai '.$bln2['nmBulan'].' Tahun Ajaran '.$thn_ajar['nmTahunAjaran'];
    ...
    header("Content-Disposition: attachment; filename=".$nama_file.".xls");
            ...
            echo '<table style="font-size: 8pt" cellpadding="2" border="0">
                        <tr>
                        ...
                        <tr><td></td></tr>
                        <tr>
                            <td align="center" style="font-size: 12pt" colspan="3"><b>Laporan Neraca per Bulan '.$bln1['nmBulan'].' Sampai '.$bln2['nmBulan'].'</b><br>Tahun Ajaran '.$thn_ajar['nmTahunAjaran'].'</td>
                        </tr>
                        <tr><td></td></tr>
                        <tr style="font-weight:bold; border-top:0.5px solid black; border-bottom:0.5px solid black; font-size: 10pt">
                        ...
                        <tr>
                            <td width="49.5%">
                                ...
                                echo    '<tr style="background-color: #dee0e3;">
